...
#define ERROR_COL float4(1,0,1,1)
 ...
 * \param contrast Contrast adjustment factor. (0-1)
 ...
 * \param color Input color.
 * \param brightness Brightness adjustment factor. (0-1)
 ...
 * \return Color with adjusted brightness.
 */
half3 Brightness(half3 color, half brightness) {
    return saturate(color * brightness);
}
