#ifndef FUR_DEPTHNORMALS
#define FUR_DEPTHNORMALS
...
GeomData DepthNormalsVertex(Attributes input)
{
...
[maxvertexcount(3*16)]
void DepthNormalsGeometry(triangle GeomData input[3], inout TriangleStream<Varyings> triStream)
{
...
)
{
    ...
    Alpha(SampleAlbedoAlpha(input.uv, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap)).a, _BaseColor, _Cutoff-input.layerDepth);
    #endif
