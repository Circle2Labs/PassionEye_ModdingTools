Shader "Toon/Fur"
{
    Properties
    {
        ...
        _LayerCount("Fur Layers Count", Range(1, 16)) = 8
        _FurLayerSpacing("Fur Layer Spacing", Range(0.001, 0.1)) = 0.01
        
        // Main color
        [MainColor]_BaseColor("Main Color", Color) = (1,1,1,1)
        [MainTexture]_BaseMap("Fur Color", 2D) = "white" {}
    ...
    SubShader
    {
        ...
        Pass {
            ...
            #include_with_pragmas "FurInput.hlsl"
        ...
        Pass {
            ...
            #pragma geometry DepthNormalsGeometry
