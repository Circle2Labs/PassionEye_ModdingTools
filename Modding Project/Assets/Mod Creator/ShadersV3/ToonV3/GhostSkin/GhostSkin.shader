Shader "Toon/GhostSkin"
{
    ...
    SubShader
    {
        ...
        Pass {
            ...
            #include_with_pragmas "GhostSkinInput.hlsl"
            #include_with_pragmas "../CommonSetup.hlsl"
            #include_with_pragmas "GhostSkinForward.hlsl"
            ENDHLSL
        }
        Pass {
            Name "ShadowCaster"
