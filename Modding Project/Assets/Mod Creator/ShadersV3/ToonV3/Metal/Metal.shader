Shader "Toon/Metal"
{
    Properties
    {
        ...
        //Metalness
        [HDR]_MetallicColor("Metallic Color", Color) = (1,1,1,1)
    ...
    SubShader
    {
        ...
        Pass {
            ...
            #include_with_pragmas "MetalInput.hlsl"
            #include_with_pragmas "../CommonSetup.hlsl"
            #include_with_pragmas "MetalForward.hlsl"
            ENDHLSL
        }
        Pass {
            Name "ShadowCaster"
