...
#pragma multi_compile _ _ADDITIONAL_LIGHTS_VERTEX _ADDITIONAL_LIGHTS //no additional lights disabled option for faster compile.
...
#pragma multi_compile _ _LIGHT_COOKIES //we might even disable this if needed
